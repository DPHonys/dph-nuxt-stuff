...
describe('the published entries', () => {
  ...
  it('all resolve for types, each through its own door', () => {
    ...
    const probes = [
      ...
      `import type { RequestInput, RequestInputOfHandler, ResponseOutputOfHandler, ValidatedContext, ValidatedEventHandler, ValidationIssue, ValidationSchemas, ValidationSchemasGuard } from '${TYPES_ENTRY}'`,
      ...
      `export type Probe = [ModuleOptions, AtLeastOne<{}, [], undefined>, DefineTypedEventHandler, ReservedTagGuard<[]>, TypedContext<{}, []>, TypedErrors<{}, []>, TypedEventHandler, TypedHandlerFn<{}, [], never, unknown>, ValidationFailed, AnyKnownError, CheckedEventHandler, ErrorFactories<[]>, KnownApiErrors, KnownErrorsOf<[]>, KnownErrorsOfHandler<never>, KnownErrorsOfRoute<'/api/users/:id'>, KnownVariant, TryResult<unknown, Error>, RequestInput<{}>, RequestInputOfHandler<never>, ResponseOutputOfHandler<never>, ValidatedContext<{}>, ValidatedEventHandler, ValidationIssue, ValidationSchemas, ValidationSchemasGuard<{}>, typeof defineTypedEventHandler, typeof defineError, typeof recognizeKnownError, typeof recognizeValidationError, typeof KNOWN_ERROR_KEY, typeof matchError, $TypedFetch, KnownApiRequestInputs, RequestInputOfRoute<'/api/users/:id'>, TypedEventFetch, TypedFetch, TypedFetchTry, TypedRequestOptions<'/api/users/:id', 'get'>]`,
    ]
