/**
 * The reuse story. There is no definer: a reusable validation is a schema
 * value - a plain export with no source keys to misspell - and composition is
 * a tuple on the source it targets. Cross-library composition falls out for
 * free, because the tuple's elements are independent Standard Schemas.
 */
...
export const profileBody = z.object({ name: z.string() })
