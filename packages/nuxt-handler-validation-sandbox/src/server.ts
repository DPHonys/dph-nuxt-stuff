/**
 * The future `@dphonys/nuxt-handler-validation/server` entry - the whole
 * runtime surface, declared without bodies. Both names are auto-imported
 * inside `server/`, the same ambient position as `defineEventHandler`.
 *
...
import type { ValidationSchemasGuard } from './internal'
import type {
  ValidatedContext,
  ValidationErrorData,
  ValidationSchemas,
...
export declare function defineValidatedEventHandler<
 ...
 */
export declare function recognizeValidationError(
  error: unknown
