/**
 * The validation adapter (core SPEC.md §3.3, §7.4), moved here verbatim when
 * the feature was parked.
 *
 ...
 *
 * ## The seam, and why it is here rather than in `./define`
 *
...
/** The schema half of a validated handler's options, as the adapter reads it. */
