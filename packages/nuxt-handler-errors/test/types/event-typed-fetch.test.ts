...
/**
 * The named-interface mandate on this surface.
 *
 ...
 * grounds — the good value is a single name, so the usual 1.5×
...
describe('event.$typedFetch, over a hand-written map', () => {
  ...
  it('has no raw member and no instance-creating member', () => {
    // The *"not a copy of `$TypedFetch`"* claim, in the form `keyof`
