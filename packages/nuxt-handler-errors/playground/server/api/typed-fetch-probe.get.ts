 ...
 *    what claims that — SPEC.md §5.3's shape floor is not assignable to that
 *    parameter, so a degraded union is a compile error rather than a silent
 *    pass. This is also SPEC.md §3.6's blessed server-to-server shape.
