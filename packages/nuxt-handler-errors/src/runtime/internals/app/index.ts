...
// composables from. Semver-honoured; not for application code. Imports
// `#app` and `vue`; must not reach `@nuxt/kit`, `nitropack/runtime`, or the
// channel-token alias - the wrappers take the token as a value, and the
