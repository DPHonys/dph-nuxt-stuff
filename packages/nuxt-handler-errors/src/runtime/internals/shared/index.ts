...
// fetch surfaces from. Semver-honoured; not for application code. May import
// `h3`; must not reach `@nuxt/kit`, `nitropack/runtime`, `#app`, or the
// channel-token alias - every factory takes the token as a value, and the
