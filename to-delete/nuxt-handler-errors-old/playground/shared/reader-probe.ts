 ...
 * the value form sits on the side-agnostic specifier *for*, and
 * the one server-to-server remapping lives in.
 *
 * This is layer 3: the union comes from the **really generated**
 ...
 * exists: the honest address is three property hops ending on a
 * key frozen as renameable protocol.
 */
 ...
 * this route's declared union rather than the shape floor —
 ...
 * that the emitted map still means something. A second
 * copy here would drift from it and claim nothing extra.
 *
 * The early return is the reader's contract in one line: `undefined` *is*
