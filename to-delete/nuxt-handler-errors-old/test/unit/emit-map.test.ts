...
describe('the generated map’s frame', () => {
  ...
  it('augments the module’s own specifier and imports the extractor from it', () => {
    ...
    expect(emitted).toContain(
      `import type { ExtractErrorsSafe } from '@dphonys/nuxt-handler-errors-old/types'`
    )
    expect(emitted).toContain(
      `declare module '@dphonys/nuxt-handler-errors-old/types' {`
    )
    expect(TYPES_SPECIFIER).toBe('@dphonys/nuxt-handler-errors-old/types')
