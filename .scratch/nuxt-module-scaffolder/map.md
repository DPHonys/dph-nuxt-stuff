...
- A single kebab-case scaffold name derives `packages/<name>`, `@dphonys/<name>`, the Nuxt module name, the camel-case config key, and the display name. Description is a separate optional input.
